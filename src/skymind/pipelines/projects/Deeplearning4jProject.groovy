...
//        } else {
        switch (module) {
            case ['libnd4j', 'nd4j']:
                platforms = [
                        [name: 'android-arm', scalaVersion: '2.11', backend: 'cpu'],
                        [name: 'android-arm64', scalaVersion: '2.12', backend: 'cpu'],
                        [name: 'android-x86', scalaVersion: '2.11', backend: 'cpu'],
                        [name: 'android-x86_64', scalaVersion: '2.12', backend: 'cpu'],

                        [name: 'ios-arm64', scalaVersion: '2.12', backend: 'cpu'],
                        [name: 'ios-x86_64', scalaVersion: '2.12', backend: 'cpu'],

                        [name: 'linux-ppc64le', scalaVersion: '2.11', backend: 'cpu'],
                        [name: 'linux-ppc64le', scalaVersion: '2.12', backend: 'cuda-9.2'],
                        [name: 'linux-ppc64le', scalaVersion: '2.12', backend: 'cuda-10.0'],
                        [name: 'linux-ppc64le', scalaVersion: '2.12', backend: 'cuda-10.1'],

                        (branchName == 'master' || branchName.contains(releaseBranchPattern)) ?
                                [name: 'linux-x86_64', os: 'centos6', scalaVersion: '2.11', backend: 'cpu'] :
                                [name: 'linux-x86_64', scalaVersion: '2.11', backend: 'cpu'],

                        (branchName == 'master' || branchName.contains(releaseBranchPattern)) ?
                                [name: 'linux-x86_64', os: 'centos6', scalaVersion: '2.12', backend: 'cpu', cpuExtension: 'avx2'] :
                                [name: 'linux-x86_64', scalaVersion: '2.12', backend: 'cpu', cpuExtension: 'avx2'],

                        (branchName == 'master' || branchName.contains(releaseBranchPattern)) ?
                                [name: 'linux-x86_64', os: 'centos6', scalaVersion: '2.12', backend: 'cpu', cpuExtension: 'avx512'] :
                                [name: 'linux-x86_64', scalaVersion: '2.12', backend: 'cpu', cpuExtension: 'avx512'],

                        (branchName == 'master' || branchName.contains(releaseBranchPattern)) ?
                                [name: 'linux-x86_64', os: 'centos6', scalaVersion: '2.12', backend: 'cuda-9.2'] :
                                [name: 'linux-x86_64', scalaVersion: '2.12', backend: 'cuda-9.2'],

                        (branchName == 'master' || branchName.contains(releaseBranchPattern)) ?
                                [name: 'linux-x86_64', os: 'centos6', scalaVersion: '2.12', backend: 'cuda-10.0']:
                                [name: 'linux-x86_64', scalaVersion: '2.12', backend: 'cuda-10.0'],

                        (branchName == 'master' || branchName.contains(releaseBranchPattern)) ?
                                [name: 'linux-x86_64', os: 'centos6', scalaVersion: '2.12', backend: 'cuda-10.1'] :
                                [name: 'linux-x86_64', scalaVersion: '2.12', backend: 'cuda-10.1'],

                        [name: 'macosx-x86_64', scalaVersion: '2.11', backend: 'cpu'],
                        [name: 'macosx-x86_64', scalaVersion: '2.12', backend: 'cpu', cpuExtension: 'avx2'],
                        /*
...
//                        [name: 'macosx-x86_64', scalaVersion: '2.11', backend: 'cuda-10.0'],
                        ...
                        [name: 'windows-x86_64', scalaVersion: '2.11', backend: 'cpu'],
                        [name: 'windows-x86_64', scalaVersion: '2.12', backend: 'cpu', cpuExtension: 'avx2'],
                        /* FIXME: avx512 */
//                        [name: 'windows-x86_64', scalaVersion: '2.12', backend: 'cpu', cpuExtension: 'avx512'],
                        [name: 'windows-x86_64', scalaVersion: '2.12', backend: 'cuda-9.2'],
                        [name: 'windows-x86_64', scalaVersion: '2.12', backend: 'cuda-10.0'],
                        [name: 'windows-x86_64', scalaVersion: '2.12', backend: 'cuda-10.1'],
                        [name: 'linux-armhf', scalaVersion: '2.11', backend: 'cpu']
                ]
                break
            case 'deeplearning4j':
                platforms = [
            ...
            case ['docs']:
                platforms = [
                        [name: 'linux-x86_64-generic', scalaVersion: '2.11']
                ]
                break
            default:
                platforms = [
                        [name: 'linux-x86_64-generic', scalaVersion: '2.11'],
                        [name: 'linux-x86_64-generic', scalaVersion: '2.12'],
                        [name: 'linux-x86_64-generic', scalaVersion: '2.12']
                ]
                break
        }
