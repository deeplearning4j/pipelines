...
dockerParams = "-v ${WORKSPACE}:${WORKSPACE}:rw -v /var/lib/jenkins/tools/docker_m2:/home/jenkins/.m2:rw  -v /var/lib/jenkins/tools/docker_ivy2/cache:/home/jenkins/.ivy2/cache:rw --device=/dev/nvidiactl --device=/dev/nvidia-uvm --device=/dev/nvidia0 --volume=nvidia_driver_367.57:/usr/local/nvidia:ro"
