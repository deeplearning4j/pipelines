    ...
    properties([
            ...
            [$class: "ParametersDefinitionProperty", parameterDefinitions:
                    [
                            ...
                            [$class: "StringParameterDefinition", name: "ND4J_VERSION", defaultValue: "", description: "Path to groovy scripts"],
//                            [$class: "StringParameterDefinition", name: "DL4J_VERSION", defaultValue: "", description: "Path to groovy scripts"],
